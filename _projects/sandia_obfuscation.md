...
categories: [research]
description: Providing support for frontier LLM benchmarking per Executive Order 14409, with a particular focus on generating and verifying obfuscated C++/Rust binaries via LLVM compiler passes.
